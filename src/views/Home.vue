<template>
  <div class="home">
    <MyInputForm name="name" label="氏名（漢字）" placeholder="氏名（漢字）を入力してください"/>
    <MyInputForm name="name_kana" label="氏名（かな）" placeholder="氏名（かな）を入力してください"/>
    ...
    <AddressForm/>
    <MyInputForm name="phone_number" label="電話番号" placeholder="電話番号を入力してください"/>
